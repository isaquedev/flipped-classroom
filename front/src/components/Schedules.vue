<template>
    <v-layout row wrap>
        ...
        <v-flex xs6>
            ...
            <v-btn dark @click="goToToday()">Ir para hoje</v-btn><br>
                    ...
                    <v-list>
                        <v-list-tile v-for="event, index in today" :key="index">
                            <v-list-tile-content>
                                ...
                                <v-list-tile-sub> {{ event.due_date.substrt(11, event.due.date.length) }} </v-list-tile-sub>
                            </v-list-tile-content>
                        </v-list-tile>
                    </v-list>
                </v-card-text>
